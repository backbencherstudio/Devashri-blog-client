...
const Slider = ({iconData}) => {
    return (
        <div className='max-w-[1128px] mx-auto 2xl:px-0 px-4 lg:mb-[120px] mb-[80px]'>
            <div>
                <h1 className='text-center uppercase font-[900] lg:text-[48px] md:text-[36px] text-2xl lg:tracking-[12px] md:tracking-[8px] leading-[110%] tracking-[4px] lg:mb-[72px] md:mb-[56px] mb-[42px]'>More Projects</h1>
