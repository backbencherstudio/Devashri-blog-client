    ...
    return (
        <div className="max-w-[1128px] mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between gap-8 py-10">
                {/* Title Section */}
                <h1 className="active text-[28px] font-semibold leading-[30.8px] tracking-[2.8px]">PROBLEM</h1>
                ...
                <div className="w-full md:w-[73%]">
                    ...
                    <div className="space-y-8 mt-8 text-[#2A2A2A]">
                        ...
                        <div>
                            <p className="text-[24px] font-semibold leading-[32px] tracking-[0.72px] opacity-80 mb-2">Underutilized Capacity</p>
                        ...
                        <div>
                            <p className="text-[24px] font-semibold leading-[32px] tracking-[0.72px] opacity-80 mb-2">Operational Inefficiencies</p>
                            <ul className="list-disc pl-6 md:pl-10 space-y-2  md:text-[24px] md:font-normal md:leading-[32px] md:tracking-[0.72px]">
                        ...
                        <div>
                            <p className="text-[24px] font-semibold leading-[32px] tracking-[0.72px] opacity-80 mb-2">Fragmented Guest Experience</p>
                            <ul className="list-disc pl-6 md:pl-10 space-y-2  md:text-[24px] md:font-normal md:leading-[32px] md:tracking-[0.72px]">
                    ...
                    {/* Closing Paragraph */}
                    <p className="md:text-[24px] text-center md:text-left font-medium leading-[26.4px] tracking-[2.4px] mt-8 md:mt-14">
