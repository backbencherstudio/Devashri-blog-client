...
const StructuringInfo = () => {
    return (
        <div className='mt-[60px] md:mt-[100px] lg:mt-[120px]'>
            ...
            THE INFORMATION</h1>
            <p className='mt-4 text-lg md:text-xl lg:text-[24px] font-medium leading-[110%] tracking-[.72px] md:tracking-[1.4px] lg:tracking-[2.4px] not-italic mb-10 md:mb-12 lg:mb-14'>Streamlining content structure for an effortless experience</p>
