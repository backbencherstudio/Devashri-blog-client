...
const ProjectGoal = () => {
  return (
    <div className="">
      <p className="active text-[26px] md:text-[48px] font-black leading-[52.8px] tracking-[9.6px] text-center opacity-25">PROJECT GOALS</p>
      ...
      <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-1">
        ...
        <div className="bg-white py-3 px-6 border-l-4 border-[#2A2A2A] flex items-center justify-center text-center">
          <h1 className="text-center text-[20px] md:text-[24px] font-semibold leading-[26.4px] tracking-[2.4px]">Goal</h1>
        </div>
        <div className="bg-white py-3 px-6 flex items-center justify-center text-center sm:col-span-1">
        <h1 className="text-center text-[20px] md:text-[24px] font-semibold leading-[26.4px] tracking-[2.4px]">Desired Outcome</h1>
        </div>
        <div className="bg-white py-3 px-6 flex items-center justify-center text-center sm:col-span-1">
        <h1 className="text-center text-[20px] md:text-[24px] font-semibold leading-[26.4px] tracking-[2.4px]">Anticipated Outcome</h1>
        </div>

        {/* Row 1 */}
        <div className="bg-white py-3 px-6 border-l-4 border-[#FF3364] text-center md:text-left text-[20px] font-medium leading-[24px] tracking-[0.6px]">
          <p className='p-6'>Digitize Activity Booking for Guests and Staff</p>
        </div>
        <div className="bg-white py-3 px-6 md:text-[20px] font-normal leading-[24px] tracking-[0.6px]">
        ...
        {/* Row 2 */}
        <div className="bg-white py-3 px-6 border-l-4 text-center md: text-left text-[20px] font-medium leading-[24px] tracking-[0.6px] border-[#FDC334]">
          <p className='p-6'>
        ...
        {/* Row 3 */}
        <div className="bg-white py-3 px-6 border-l-4 text-center md:text-left text-[20px] font-medium leading-[24px] tracking-[0.6px] border-[#2198F6]">
        <p className='p-6'>
