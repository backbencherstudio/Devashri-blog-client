    ...
    return (
        <div>
           <div className='max-w-[1128px] mx-auto md:pt-[72px] pt-[36px]  px-4 2xl:px-0'>
                ...
                <div>
                    {open ? <div>
                        <ul className='font-medium text-[#2A2A2A] text-[20px] flex flex-col gap-3 md:hidden  uppercase  w-[220px] min-h-screen bg-zinc-100 z-30 fixed top-0 left-0 pt-[36px] p-4 '>      
                            <li><NavLink to={"/"}>HOME</NavLink></li>
                            <li><NavLink to={"/about"}>about</NavLink></li>
                            <li><NavLink to={"/playground"}>playground</NavLink></li>
                            <li><NavLink to={"/resume"}>resume</NavLink></li>
