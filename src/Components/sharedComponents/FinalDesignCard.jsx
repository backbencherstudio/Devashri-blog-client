        ...
        <div className="md:mb-40">
            ...
            <p className="mb-12 md:text-[24px] text-center font-normal leading-[32px] tracking-[0.72px] not-italic">
                ...
                <div className="relative w-full max-w-[900.421px] h-auto flex-shrink-0 mx-auto">
                    ...
                    <div
                        className="absolute bottom-[-30px] right-[-10px] sm:bottom-[-40px] sm:right-[-30px] md:bottom-[-50px] md:right-[-40px] w-[80px] h-[160px] sm:w-[100px] sm:h-[200px] md:w-[201.931px] md:h-[414.992px] z-30"
                    >
                        <img
