  ...
  return (
    <div className="mt-[120px]">
      ...
      <div className="lg:mt-[80px] md:mt-[56px] mt-[40px] grid grid-cols-1 md:grid-cols-3 gap-1">
        ...
        <h1 className="text-center lg:py-6 md:py-4 text-[20px] md:text-[24px] font-medium leading-[26.4px] tracking-[2.4px]">Desired Outcome</h1>
        </div>
        <div className="bg-white  flex items-center justify-center text-center sm:col-span-1">
        <h1 className="text-center lg:py-6 md:py-4 text-[20px] md:text-[24px] font-medium leading-[26.4px] tracking-[2.4px]">Anticipated Outcome</h1>
        </div>
        ...
        {/* Row 2 */}
        <div className="bg-white py-3 px-6 border-l-4  md: text-left text-[20px] font-medium leading-[24px] tracking-[0.6px] border-[#FDC334]">
          <p className='p-6'>
            Ensure Effortless Event Planning and Management
          </p>
        </div>
        <div className="bg-white py-3 px-6 md:text-[18px] font-normal leading-[24px] tracking-[0.6px]">
