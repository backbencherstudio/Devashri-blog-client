...
const BriefSecOfCaseSec = ({briefObj}) => {
    return (
       <div>
         <div className="flex flex-col md:flex-row justify-between mt-20 xl:mt-48 gap-6 md:gap-0 lg:mt-[150px] md:mt-[100px]  ">
    {/* Title */}
    ...
    {/* Description */}
    <div className='flex md:flex-row flex-col md:w-[74%]  gap-6 md:gap-0  justify-between'>
    <div className="md:max-w-[48.57%]  text-justify text-base md:text-xl lg:text-2xl tracking-[.32px] md:tracking-[.52px] lg:tracking-[.72px]  text-[#2A2A2A] md:text-left">
        <p>{briefObj.paragraph}</p>
    </div> 

    {/* Card */}
    <div className="bg-[#F2ECEB] pt-6 pl-6 md:w-[31.43%]  text-base md:text-xl lg:2xl">
        {/* Role */}
        <div className="mb-12">
