    ...
    return (
        <div>
            ...
            {/* Affinity Mapping Text */}
                <h1 className="text-[24px] font-normal leading-[110%] tracking-[2.4px] not-italic text-[#DD0101] md:w-1/3">
                    AFFINITY MAPPING & IDEATION
                </h1>

                {/* Deriving Insights Section */}
                <div className="md:w-full">
                    <h1 className="text-[24px] font-medium leading-[110%] tracking-[2.4px] not-italic mb-6">
                    Deriving Insights
                    </h1>
                    <ul className="list-disc ml-8">
                        <li className="mb-4 text-[24px] font-normal leading-[110%] tracking-[2.4px] not-italic">
