...
const TheSolution = () => {
  return (
    <div className="px-4 sm:px-8 lg:px-16">
      {/* Title */}
      <h1 className="text-[#DD0101] text-[48px] font-extrabold leading-[110%] tracking-[12px] not-italic my-28 opacity-25 text-center md:text-left">
        THE <br />
        SOLUTION
      </h1>
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div>
          <h1 className="text-[24px] font-medium leading-[110%] tracking-[2.4px] not-italic mb-6 text-center md:text-left">
            Structuring the Experience
          </h1>
          <ul className="text-[24px] font-normal leading-[110%] tracking-[2.4px] not-italic list-disc pl-8">
            <li className="mb-4">
      ...
      <h1 className="p-8 text-center py-14 text-[#DD0101] text-[24px]  leading-[110%] tracking-[2.4px]">
