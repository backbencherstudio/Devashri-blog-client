                            ...
                            <form onSubmit={handleLogIN} action="">
                                ...
                                <div className="relative inline">
                                    <input
                                        ...
                                        placeholder="Enter Password"
                                        name="password"
                                        className="border  md:placeholder:text-xl placeholder:text-lg text-2xl md:px-4 md:py-[15px] p-3 md:pr-[9%] pr-[17%] bg-white text-[#2A2A2A] rounded-[8px]  mt-6 md:mt-10 lg:mt-12 sm:w-[300px] md:w-[390px] w-full"
                                    />
                                    {showIcon && (
                                        <button
                                            type="button"
