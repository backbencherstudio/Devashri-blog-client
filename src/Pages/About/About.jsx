    ...
    return (
        <div className='max-w-[1128px] mx-auto px-4 2xl:px-0 lg:mb-[200px] md:mb-[150px] mb-[100px]'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 dynamic-margin'>
                ...
                <div className=' order-1 flex h-full w-full items-end'>
            ...
            <div className='mt-4 '>
                ...
                <h2 className='lg:mb-10 md:mb-8 mb-6 text-[16px] md:text-[24px] lg:text-[32px] leading-[125%] font-medium' style={{
                ...
                <div className='space-y-4 md:space-y-6'>
                    <p className='text-base md:text-[20px] leading-[166%] lg:text-2xl md:tracking-[1.2px] tracking-[.72px]'>
                    ...
                    <p className="text-base md:text-[20px] leading-[166%] lg:text-2xl md:tracking-[1.2px] tracking-[.72px]">
                        I graduated from <span className="font-semibold text-red-500">Nagpur University in India</span> with a
                        ...
                        <span className="font-medium"> Professional Bootcamp in UX/UI Design</span> from <span className="font-semibold text-red-500">Designboat UI/UX School in India</span>, where I honed my skills in user-centered design.
                    </p>
