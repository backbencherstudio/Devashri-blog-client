...
const WebToolResortStuff = () => {
    return (
        <div className='bg-[#F2ECEB] w-full lg:py-[104px] md:py-[80px] py-[50px]'>
            <div className=' text-center max-w-[1128px] mx-auto 2xl:px-0 px-4'>
                ...
                <p className=' lg:text-2xl md:text-[20px] text-[16px] font-normal leading-[110%] lg:tracking-[2.4px] md:traking-[1.4px] tracking-[.7px] '>Luxe Events provides <span className='font-medium'>real-time booking management</span>  and <span className='font-medium'> performance insights</span> for Super <span className='font-medium'> Admins, Resort Admins, Concierges, and Guides.</span>  Intuitive dashboards enable staff to track engagement, monitor attendance, and make data-driven decisions for seamless operations and enhanced guest experiences.</p>
